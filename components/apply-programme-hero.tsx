                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1.5">
                      ...
                      <select className="border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#a8248c] rounded-sm bg-white text-gray-500">
                        ...
                        <option>QeDu Education</option>
                        <option>TechUp Industry</option>
                      </select>
                    </div>
                  </div>
                )}
                ...
                {step === 4 && (
                  <div className="grid grid-cols-1 gap-5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <textarea
                        rows={3}
                        placeholder="What made you choose this one? Be specific about what you're hoping to learn or build."
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <textarea
                        rows={3}
                        placeholder="Tell us what success looks like for you in the future."
                        className="border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#a8248c] rounded-sm resize-none"
                      ></textarea>
                    </div>
                    <div className="flex flex-col gap-1.5">
