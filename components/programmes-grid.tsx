...
export default function ProgrammesGrid() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // For now, we simulate a 1.5-second network request so you can see the UI
                ...
                >
                  ...
                  <div className="p-6 md:p-8 flex flex-col flex-1">
                    ...
                    <div className="mt-auto flex flex-col items-start">
                      ...
                      {/* Opens the Modal instead of routing to a new page */}
                      <Button
      ...
      {selectedProg && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            {/* Header */}
            <div className="bg-[#FDF8FD] px-6 py-5 border-b border-gray-100 flex justify-between items-center">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#a8248c] block mb-1">
                  Application Form
                </span>
                <h3 className="text-xl font-serif font-bold text-[#1a1543] line-clamp-1">
                  {selectedProg.title}
                </h3>
              </div>
              <button
                onClick={closeModal}
                className="text-gray-400 hover:text-[#a8248c] transition-colors p-2"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
              ...
              {isSuccess ? (
                ...
                <div className="py-12 flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-xs">
                    Thank you for applying to {selectedProg.title}. Our team
                    will review your details and reach out soon.
                  </p>
                  <Button
                    onClick={closeModal}
                    className="bg-[#1a1543] hover:bg-black text-white rounded-full px-8 py-5 text-xs font-bold tracking-widest uppercase w-full"
                  >
                    Done
                  </Button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-[#a8248c] focus:border-[#a8248c] block p-3 outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-[#a8248c] focus:border-[#a8248c] block p-3 outline-none transition-colors resize-none"
